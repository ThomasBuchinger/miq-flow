...
#
# Configure a remote repository (which will be cloned to a temporary
# directory when needed) On ManageIQ appliances, only HTTPS URLs are allowed,
# because SSH support must be enabled in rugged at complile time
