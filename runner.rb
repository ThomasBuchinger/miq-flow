...
require 'lib/miq/provider_noop.rb'
require 'lib/utils.rb'

$logger  = Logger.new(STDOUT)
$logger.level = Logger::DEBUG
#$branches = { 'master'=>{'fs_domain'=>'buc', 'miq_domain'=> 'buc'}, 'template'=>{'fs_domain'=>'buc'} }

# $git_repo needs to be specified in custom.rb
#$git_repo = Rugged::Repository.new('../automate-example')
$default_opts = {:miq_fs_domain=>'foo', :miq_provider=>GitFlow::MiqProvider::Noop.new()}
